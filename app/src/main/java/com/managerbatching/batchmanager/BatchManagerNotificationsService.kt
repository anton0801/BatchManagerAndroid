...
class BatchManagerNotificationsService : FirebaseMessagingService() {

    companion object {
        private const val BATCH_MANAGER_CHANNEL_ID = "batch_manager_notifications"
        private const val SLEEP_RELAX_CHANNEL_NAME = "Batch Manager Notifications"
        private const val SLEEP_RELAX_NOT_TAG = "BATCH_MANAGER"
    }
