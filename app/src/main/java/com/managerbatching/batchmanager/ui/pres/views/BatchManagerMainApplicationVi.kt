...
class BatchManagerMainApplicationVi(
    private val eggLabelContext: Context,
    private val batchManagerCallback: BatchManagerCallBack,
    ...
    private fun appMEnableStableInputScroll() {
        evaluateJavascript(
            """
        (function() {
    ...
    private fun eggLabelHandleCreateWebWindowRequest(resultMsg: Message?) {
        ...
        if (resultMsg.obj != null && resultMsg.obj is WebViewTransport) {
            ...
            val windowWebView = BatchManagerMainApplicationVi(eggLabelContext, batchManagerCallback, eggLabelWindow)
            transport.webView = windowWebView
            resultMsg.sendToTarget()
            batchManagerCallback.feedMixHandleCreateWebWindowRequest(windowWebView)
        }
    }
